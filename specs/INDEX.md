...
| 2026-08-06 | [reverse-engineering-skill](2026-08-06-reverse-engineering-skill/spec.md) | Draft | Dedicated pre-planning discovery skill (`chowa-discover`) to systematically audit codebases, discover architecture, repository customs, workflow rules (`.agents/AGENTS.md`, `CLAUDE.md`, git style), and extract profiles consumable by Chōwa's Stage 1 (`spec.md`) and Stage 2 (`implementation_plan.md`) feature planning. |
