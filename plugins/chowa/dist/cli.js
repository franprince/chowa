...
async function handleInit() {
  ...
  try {
    ...
    writeFileSync(plan.targetPath, defaultConfigFileContents2(), "utf-8");
...
async function handleAlwaysOn(arg) {
  ...
  const path = defaultPreferencesPath2(homedir());
  ...
  if (arg === "on" || arg === "off") {
    ...
    writeFileSync(path, serializePreferences2({ alwaysOn: arg === "on" }), "utf-8");
